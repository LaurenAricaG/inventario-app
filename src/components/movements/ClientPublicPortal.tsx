          ...
          <TableBody>
            {movements.length === 0 ? (
              <TableRow>
                <TableCell
                  colSpan={5}
                  className="py-8 text-center text-text-tertiary italic"
                >
              ...
              movements.map((m) => {
                const hasDetails =
                  m.type === "VENTA_DIRECTA" || m.type === "PEDIDO_CATALOGO";
                  ...
                  <TableRow key={m.id}>
                    <TableCell className="whitespace-nowrap text-text-secondary select-none font-medium">
                      <div className="flex items-center gap-2">
                        ...
                        <span>{formatDateLocal(m.date)}</span>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center whitespace-nowrap">
                      {hasDetails ? (
                        ...
                        <span className="text-text-tertiary font-mono text-xs select-none">
                          -
                        </span>
                      )}
                    </TableCell>
